...
<table class="form-group">
	...
	<tr>
		...
		<td align="left"><input type="text" id="fullName" name="fullName"
			size="45" value="${customer.fullname}" class="form-control" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td align="left"><input type="text" id="phone" name="phone"
			size="45" value="${customer.phone}" class="form-control" /></td>
	</tr>
	<tr>
		<td align="right">Thành phố:</td>
		<td align="left"><input type="text" id="city" name="city"
			size="45" value="${customer.city}" class="form-control" /></td>
	</tr>
	<tr>
		<td align="right">Zip code:</td>
		<td align="left"><input type="text" id="zipCode" name="zipCode"
			size="45" value="${customer.zipcode}" class="form-control" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td align="left"><textarea id="address" name="address"
				class="form-control">${customer.address}</textarea></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
