					...
					<div class="row justify-content-center">
						<div class="col-lg-5">
							<div class="p-5">
								...
								<c:if test="${ review != null }">
									<form class="user" id="reviewForm" action="update_review"
										method="post" autocomplete="off">
										<input type="hidden" name="reviewId"
											value="${review.reviewId}">
								</c:if>
								<c:if test="${review == null}">
									<form class="user" id="reviewForm" action="create_review"
										method="post" autocomplete="off">
								</c:if>
								...
								<table class="form">
									...
									<tr>
										...
										<td align="left"><textarea style="width: 100%"
												name="comment">${review.comment}</textarea></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
									</tr>
								...
								<div>
									<input type="button" value="Lưu"
										class="btn btn-primary btn-user btn-block" id="btnsubmit"
										onclick="submitForm()"> <a type="button"
